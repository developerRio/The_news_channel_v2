...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<HashMap<String, String>> arrayList = Paper.book().read("dataListH", null);
        ...
        if (!connectionDetector.isConnected()){
            ...
            DownloadHealthNews downloadHealthNews = new DownloadHealthNews();
            downloadHealthNews.execute();
        }

        return view;
    }

    public class DownloadHealthNews extends AsyncTask<String, Void, String> {
        @Override
            ...
            if (xml.length() > 10) { // checking if not empty
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArrays.length(); i++) {
                        ...
                        if (connectionDetector.isConnected()){
                            Paper.book().write("dataListH", dataList);
                        }
