...
public class BusinessFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<HashMap<String, String>> arrayList = Paper.book().read("dataListB", null);
        ...
        if (!connectionDetector.isConnected()){
            ...
            DownloadBusinessNews newsTask = new DownloadBusinessNews();
            newsTask.execute();
        }
    ...
    public class DownloadBusinessNews extends AsyncTask<String, Void, String> {
        @Override
            ...
            if (xml.length() > 10) { // checking if not empty
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArrays.length(); i++) {
                        ...
                        if (connectionDetector.isConnected()){
                            Paper.book().write("dataListB", dataList);
                        }
