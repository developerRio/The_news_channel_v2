...
public class SportsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<HashMap<String, String>> arrayList = Paper.book().read("dataListS", null);
        ...
        if (!connectionDetector.isConnected()){
            ...
            DownloadSportsNews downloadSportsNews = new DownloadSportsNews();
            downloadSportsNews.execute();
        }
        return view;
    }

    public class DownloadSportsNews extends AsyncTask<String, Void, String> {
        @Override
            ...
            if (xml.length() > 10) { // checking if not empty
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArrays.length(); i++) {
                        ...
                        if (connectionDetector.isConnected()){
                            Paper.book().write("dataListS", dataList);
                        }
