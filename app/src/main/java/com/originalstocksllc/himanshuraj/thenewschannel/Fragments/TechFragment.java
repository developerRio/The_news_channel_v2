...
public class TechFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<HashMap<String, String>> arrayList = Paper.book().read("dataListT", null);
        ...
        if (!connectionDetector.isConnected()){
            ...
            DownloadTechNews downloadTechNews = new DownloadTechNews();
            downloadTechNews.execute();
        }

        return view;
    }

    public class DownloadTechNews extends AsyncTask<String, Void, String> {
        @Override
            ...
            if (xml.length() > 10) { // checking if not empty
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArrays.length(); i++) {
                        ...
                        if (connectionDetector.isConnected()){
                            Paper.book().write("dataListT", dataList);
                        }
