...
public class FunctionCurrentWeather {
    ...
    private static final String OPEN_WEATHER_MAP_API = "5f6e3835c7ae50ada6b5d9276b521999";
    ...
    public static JSONObject getWeatherJSON(String cityName){
        try {
            ...
            String newLong = newIntent.getStringExtra("longitude");
            String newLat = newIntent.getStringExtra("latitude");*/

            URL url = new URL(String.format(OPEN_WEATHER_MAP_URL, cityName));
